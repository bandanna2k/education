...
public class MultiPartyEncryptionTest
{
    ...
    public void canMultiplePersonsReadEncryptedData()
    {
        ...
        assertThat(new String(decrypted1)).isEqualTo(text);
        assertThat(new String(decrypted2)).isEqualTo(text);
        assertThat(new String(decrypted3)).isEqualTo(text);
        assertThat(new String(decrypted4)).isEqualTo(text);
    ...
    public void canAnybodyReadTheData()
    {
        ...
        assertThat(new String(encrypted)).isNotEqualTo(text);
    }
