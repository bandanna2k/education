...
public class ErrorResponse   {
  ...
  @ApiModelProperty(example = "BAD_REQUEST", value = "Error code identifier")
  @JsonProperty("code")
  ...
  @ApiModelProperty(example = "Invalid request parameters", value = "Human-readable error message")
