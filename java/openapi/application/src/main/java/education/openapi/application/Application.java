...
import static education.openapi.application.ToBeRenamed.toVertxPath;
...
public class Application
{
    ...
    private final Handler<RoutingContext>[] operations;

    public Application(Vertx vertx, Handler<RoutingContext>... operations) {
        this.vertx = vertx;
    ...
    private void addHandler(Router router, Handler<RoutingContext> operation)
    {
